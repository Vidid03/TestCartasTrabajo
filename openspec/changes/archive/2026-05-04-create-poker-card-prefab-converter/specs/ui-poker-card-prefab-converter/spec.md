...
El sistema SHALL proveer un prefab de carta UI que mantenga estructura y comportamiento compatibles con las cartas actuales para permitir reemplazo directo.
